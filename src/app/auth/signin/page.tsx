        ...
        <Card className="w-full max-w-md mx-4 border-0 shadow-2xl backdrop-blur-sm bg-card/90 relative z-10">
            <CardHeader className="text-center pb-2">
                ...
                <CardTitle className="text-3xl font-bold">
                    <span className="gradient-text">ExcoDesk</span>
                </CardTitle>
            ...
            <CardContent className="space-y-5 pt-4">
                ...
                <div className="rounded-lg bg-muted/50 p-3 space-y-1.5">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-muted-foreground">
                        <span className="font-mono">admin@exco.fr</span>
                        <span>Super Admin</span>
                        <span className="font-mono">agent1@exco.fr</span>
                        <span>Agent</span>
                        <span className="font-mono">user1@exco.fr</span>
                        <span>End User</span>
                    </div>
