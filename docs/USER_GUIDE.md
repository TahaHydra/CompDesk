# 📖 ExcoDesk — User & Administrator Guide

Welcome to ExcoDesk, your organization's IT helpdesk and ticketing system. This guide covers everything you need to know as an **end user**, **agent**, or **administrator**.
...
1. Go to `https://excodesk.yourorg.com` (or `http://localhost:3000` for development)
...
| Email | Role | Password |
|-------|------|----------|
| `admin@exco.fr` | Super Admin | `Password123!` |
| `agent1@exco.fr` | Agent | `Password123!` |
| `agent2@exco.fr` | Agent | `Password123!` |
| `user1@exco.fr` | End User | `Password123!` |
| `user2@exco.fr` | End User | `Password123!` |

### Navigation

- **Sidebar** — Main navigation on the left side. Click the ExcoDesk logo to return to the Dashboard at any time.
...
### Can I integrate ExcoDesk with other tools?
